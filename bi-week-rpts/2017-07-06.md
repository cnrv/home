...
很多人正在讨论 AUIPC和JALR fusion成direct jump或其他fusion的可能性。AArch64中也有instruction-fusion，A72就有使用这个功能。此外，这个讨论串还包含了User level 2.2 spec中return-address stack prediction hint 设计的[由来。]
