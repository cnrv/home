...
其中包括拆分uncore，将所有子工程划入freechips.rocketchip工程包，添加devices工程包，继续移除历史遗留代码（ground test和原有配置逻辑），
深化代码模块化和编译时模块化自动配置。

参见：[rocket-chip PR 845](https://github.com/freechipsproject/rocket-chip/pull/845)

> ([hcook](https://github.com/hcook) wants to commits into master from freechips-packages)
>
...
参见：[rocket-chip PR 849](https://github.com/freechipsproject/rocket-chip/pull/849)

> ([aswaterman](https://github.com/aswaterman) merged commits into master from l2-tlb)
>
