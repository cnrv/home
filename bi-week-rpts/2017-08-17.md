...
### 以色列關於RISC-V的Genpro計劃
以色列的 Israel Innovation Authority 最近公布了 2018 年 關於RISC-V的[Genpro計劃](http://www.jewishpress.com/news/on-campus/2018-israeli-technological-innovation-consortia-launch-underway/2017/08/02/)。希望能建立一個以RISC-V為基礎的運算平台。
...
Palmer的[文章](https://www.sifive.com/blog/2017/08/14/all-aboard-part-1-compiler-args/)記錄了要怎麼讓GCC使用不同的ISA和ABI。Palmer計畫針對他有涉獵的port，譬如Linux和GCC，寫一連串的文章。
