...
### [RISC-V 的 Formal specification 小組](https://groups.google.com/a/groups.riscv.org/forum/?utm_medium=email&utm_source=footer#!topic/isa-dev/DxKrkE6_LOM)
這個小組正在制定 RISC-V 的 Formal specification。目前已經有四個小組，嘗試著制定和實現。使用的語言包括L3,verilog, Haskell和 BSV。
目前 Rishiyur所帶的小組正要整合這幾個 specification 和實現。
有興趣的朋友可以加入這小組參與討論，或參考這些repo：

1. Prashant Mundkur (SRI); written in L3
[Link]https://github.com/pmundkur/l3riscv
2. Clifford Wolf (individual); written in Verilog
        https://github.com/cliffordwolf/riscv-formal
3. Adam Chlipala and group (MIT); written in Haskell
        (public link not yet available)

4. Rishiyur Nikhil (Bluespec, Inc.); written in BSV
