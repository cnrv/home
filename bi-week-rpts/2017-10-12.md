...
10月10日，由武汉聚芯微电子有限公司和北京九天卫星科技发展有限公司联合开发的蜂鸟E200系列处理器正式发布。
...
**特别标注**，该处理器的主要开发者是CNRV微信群中的**胡振波**同学。

#### 开源代码 https://github.com/SI-RISCV/e200_opensource
#### 文档介绍 [https://git.io/vdKeR](https://github.com/SI-RISCV/e200_development/blob/master/doc/Hummingbird_E200_Series_Core_SoC_Introduction.pdf)
...
#### CoreGuard的連結: [link](https://globenewswire.com/news-release/2017/10/04/1140783/0/en/Dover-Microsystems-Launches-CoreGuard.html)
...
#### 详细的设计理念可参考文档：[连结](https://www2.eecs.berkeley.edu/Pubs/TechRpts/2017/EECS-2017-157.pdf)

### Palmer的 All aboard Part2 整理
在 Part2中 Palmer 继续介绍 toolchain，并提到了relocation这个概念。relocation指的是，linker在将各个目的档连结起来时，需要把 global variable的位址以及其他Compiler无法事先知道的位址填起来。如同Palmer在这段所提到的：
...
介绍完 linker relocation这个概念后，文章最后利用一个摆的太远的例子，来解释 "relocation truncated to fit" 这个gcc 会出现的 error message。具体的说，R\_RISCV\_HI20+R_RISCV\_LO12\_I 这个relocation pair 最大只能产生0x7FFFFFFF这样的绝对位址。要跳到更远，就会出现这个 error。

#### 更多细节可参考 All aboard part2：[link](https://www.sifive.com/blog/2017/08/21/all-aboard-part-2-relocations/)
