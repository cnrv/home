...
長久以來，rocket-chip只能通過用 TileLink-AXI-bridge 來實現一個AXI接口的Crossbar，而沒有一個獨立的AXI Crossbar。
...
Ashling是一家提供嵌入式軟件解決方案和調試工具的公司，這家公司最近加入了基金會。Aahling會在最近的Workshop上 demo 他們的一個RISC-V IDE。
