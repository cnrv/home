...
David Chisnall 在isa-dev上公开了J extension group的计画，并徵求夥伴加入。这个 workgroup 将针对 managed, interpreted 和 JITed 的语言，像是 C#, Go, Haskell, Java, JavaScript, OCaml, PHP, Python, R, Ruby, Scala or WebAssembly等，提出扩展。可能的方式包括针对 GC和 overflow check的 support。
