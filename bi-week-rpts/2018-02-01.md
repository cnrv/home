...
Link:[glibc risc-v port upstreamed](https://sourceware.org/ml/libc-alpha/2018-01/msg01082.html)
Link:[glibc wiki with test results of risc-v port](https://sourceware.org/glibc/wiki/Release/2.27#RISC-V_.28rv64imac.2BAC8-lp64.29)
...
+ Link:[新的mailing list](http://lists.infradead.org/pipermail/linux-riscv/)
+ Link:[新的git repo](git git://git.kernel.org/pub/scm/linux/kernel/git/palmer/riscv-linux.git)
+ Link:[linux 4.15](https://lkml.org/lkml/2018/1/28/173)
+ Link:[linux 4.15-rc9](http://lkml.iu.edu/hypermail/linux/kernel/1801.2/04632.html)
