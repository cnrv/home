...
- 更多细节请参考[PULP官网](https://www.pulp-platform.org/)
- PULP 在 HPCA 的[slides](https://github.com/pulp-platform/hpca18-workshop)
...
Link: [Express Logic’s X-Ware IoT Platform® Brings Industrial-Grade IoT Support to RISC-V Architecture](Express Logic’s X-Ware IoT Platform® Brings Industrial-Grade IoT Support to RISC-V Architecture)
