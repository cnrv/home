...
### PULP 虚拟平台（PULP Virtual Platform）发布
  ...
  4月30日，由苏黎世联邦理工学院（ETHZ）和 意大利博洛尼亚大学（Unibo）开发的 新的 PULP Virtual Platform 在 GitHub 上发布（https://github.com/pulp-platform/gvsoc.git)。 
  据小编所知，新的Virtual Platform 目前还在不断完善当中，还需要加入RTL 仿真等功能，欢迎大家反馈意见。PULP Virtual Platform 将会是一款强大的平台，兼容所有的PULP硬件平台的功能，而且也会有很多PULP硬件平台没有的新功能，尽请期待。
## 技术讨论
