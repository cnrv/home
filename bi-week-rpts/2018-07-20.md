...
大意是说：
risc-v的指令还没有加入FSF(Free Software Soundation)的binutils中，所以FSF过去没有持续维护汇编器和反汇编器关于risc-v指令功能。
...
在riscv-tools/riscv-opcodes/opcodes包括了risc-v现在支持的所有指令，而且被分门别类的整理好了。
