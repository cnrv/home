...
`Tommy Murphy`在`RISC-V SW Dev`提完说，
...
FADU和Mobiveil两家公司相继宣布采用SiFive的RISC-V CPU用于其SSD控制其解决方案。这也从侧面证明了一些细分垂直领域（垂直这里是指软件和芯片都由自己开发）,RISC-V无需生态的过多支持，可以被快速的导入。
...
活动报名网站：[https://www.bagevent.com/event/1770532](https://www.bagevent.com/event/1770532)
Mobiveil和FADU最近都宣称采用了SiFive家的CPU IP用于SSD控制器解决方案。这一定程度上能够说明RISC-V在一些垂直的项目中(垂直指软件和硬件都是自己设计)中能够很好的替代传统的解决方案从而进一步降低成本。

Links:

- [Mobiveil Inc. and SiFive partner to develop RISC-V based configurable SSD Platform For Data Center and Enterprise storage Applications](https://www.sifive.com/posts/2018/08/07/mobiveil-inc-and-sifive-inc-partner-to-develop-risc-v-based-configurable-ssd-platform-for-data-center-and-enterprise-storage-applications/)
- [FADU Launches Industry Leading SSD Solutions Powered by SiFive RISC-V Core IP](https://www.sifive.com/posts/2018/08/07/fadu-launches-industry-leading-ssd-solutions-powered-by-sifive-risc-v-core-ip/)
