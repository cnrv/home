...
由David Patterson, Andrew Waterman撰写的《RISC-V手册：一本开源指令集的指南》今日由包云岗老师带领的团队翻译完成。并在杭州互联网大会上CRVA成立仪式上发布，David Patterson现场也做了签名赠书活动。这本书的中文翻译目前以CC-BY-NC-SA 3.0 License发布。鼓励读者们对翻译做出改进，提交PR即可。
...
群头表示微信处于安全原因不支持在公众号文章中打开外链，故未来将尽可能转向分享H5页面的方式发布简报，望谅解。
