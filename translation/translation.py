...
with codecs.open('./2017-12-21.tc.md',encoding='utf-8') as f:
	with codecs.open('./bi-weekly-12-21-2.tc.md',"w",encoding='utf-8') as g:
		content=f.read()
		#print content
