...
with codecs.open('./2018-01-04.tc.md',encoding='utf-8') as f:
	with codecs.open('./bi-weekly-01-04-2.tc.md',"w",encoding='utf-8') as g:
		content=f.read()
		#print content
