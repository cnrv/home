...
with codecs.open('./2018-02-01-temp.tc.md',encoding='utf-8') as f:
	with codecs.open('./2018-02-01-temp2.tc.md',"w",encoding='utf-8') as g:
		content=f.read()
		#print content
