...
with codecs.open('./bi-weekly-01-18-2.tc.md',encoding='utf-8') as f:
	with codecs.open('./bi-weekly-01-18-3.tc.md',"w",encoding='utf-8') as g:
		content=f.read()
		#print content
